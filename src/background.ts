class Background {
  ...
  constructor(
    public searchEngine: string = "google",
    public translateSite: string = "googleTrans",
    public translateFrom: string = "en",
    public translateTo: string = "zh-CN"
  ) {
    let self = this;
            ...
            function (items) {
              ...
              switch (self.translateSite) {
                case "baiduTrans":
                  ...
                  translateUrl =
                    Background.BAIDU_TRANSLATE_URL +
                    "/#" +
                    self.translateFrom +
                    "/" +
                    self.translateTo +
                ...
                default:
                  translateUrl =
                    Background.GOOGLE_TRANSLATE_URL +
                    "?sl=auto&tl=" +
                    self.translateTo +
                    "&text=" +
                    word +
